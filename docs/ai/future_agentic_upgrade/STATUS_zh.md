...
| P6 | AI Chat 多分支对话树状可视化(呈现多分支对话结构,可点击切分支) | in progress | 形态已敲定(按钮→浮层、节点=消息+首句摘要+活跃路径高亮);brief 定稿;Codex 执行批次 1–4(数据→provider→浮层→入口/切换),出 UI 后停待审+真机 | `briefs/P6_conversation_tree_zh.md` |
