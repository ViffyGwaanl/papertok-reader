...
| R1 | 拆分 ai_chat_stream.dart god file | in progress | 批次 1–8 已审过(纯机械、god file 16618→13453、9 视图≤718 行、76 测试过、未越界);放行 9–11(设置/控制、快照编排器、卡骨架);抽完评估 ≤3000 DoD(非 Seminar 聊天 UI 或需后续批) | `briefs/R1_godfile_split_zh.md` |
