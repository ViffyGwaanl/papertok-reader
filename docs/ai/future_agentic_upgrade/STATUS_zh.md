...
| --- | --- | --- | --- | --- |
| P1 | AI Chat 原生研讨会(收口为"观看+追问"形态) | 待真机验收 | 焦点项 4/10a/12 真机已过(2026-06-15);待补确认 10(冻结卡无死控件+引导行)与 8/13,全过由用户标 done 并启动 R1 | `briefs/P1_ACCEPTANCE_zh.md`(v6) |
...
| 2026-06-15 | P1 六轮(v6 脚本,build 6532) | 焦点项通过 | 4 滚动稳定、无到底回弹;10a 主对话追问能引用研讨结论(F19a 生效);12 文本整洁、无裸 id/字面 \n。待补全量:10 冻结卡、8 各 tab 展开、13 长内容导航 |
