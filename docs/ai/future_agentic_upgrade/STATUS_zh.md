...
| P6 | AI Chat 多分支对话树状可视化(呈现多分支对话结构,可点击切分支) | in progress | 批次 1–2 已完成(数据适配+provider 只读树/activatePathToNode+conversationV2 持久化);继续批次 3(只读浮层渲染) | `briefs/P6_conversation_tree_zh.md` |
