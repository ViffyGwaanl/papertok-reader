...
| P6 | AI Chat 多分支对话树状可视化(呈现多分支对话结构,可点击切分支) | in progress | 批次 1 已完成(树数据适配 → conversation_tree/,空树/单节点/多分支/深路径测试);继续批次 2(provider 暴露+切换持久化) | `briefs/P6_conversation_tree_zh.md` |
