...
| R1 | 拆分 ai_chat_stream.dart god file | in progress | 批次 1–11 已抽出(11 卡骨架 → seminar/,god file 12063→11667);停在批次 11 后评估 ≤3000 DoD(非 Seminar 聊天 UI 或需后续批) | `briefs/R1_godfile_split_zh.md` |
