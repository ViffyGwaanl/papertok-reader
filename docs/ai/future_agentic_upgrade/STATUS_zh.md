...
| --- | --- | --- | --- | --- |
| P1 | AI Chat 原生研讨会(收口为"观看+追问"形态) | 待真机验收 | 8/13/10a 已过;六轮暴露 F20(生成/思考标签闪烁)、F21(结束后残留"主持人等待插话");Codex 修 F20/F21 后重测,全过由用户标 done 并启动 R1 | `briefs/P1_ACCEPTANCE_zh.md`(v6) |
