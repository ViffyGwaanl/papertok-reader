...
- 删除旧独立 Seminar 页面；恢复详情和后续完整详情能力都在 Chat run card 内完成。
...
- 旧独立 Seminar 页面已删除；日常入口和恢复详情都落在 AI Chat 的结构化 Seminar run card 内。
