...
- 把当前带 snapshot 和首片送审按钮的历史任务卡继续升级为完整 AI Chat message part / run 卡片，补齐完整白板、历史卡离线送审详情子视图、run-scoped composer 子视图和 per-run 多实例隔离。
