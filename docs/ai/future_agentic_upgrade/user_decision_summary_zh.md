...
- 把当前带 snapshot、白板正文首片、首片送审按钮、completed 卡内读者参与 composer 和 AI Chat scoped runtime 的历史任务卡继续升级为完整 AI Chat message part / run 卡片，补齐历史卡离线送审详情子视图、分歧 tab、message part schema migration 和独立详情页 scoped store。
