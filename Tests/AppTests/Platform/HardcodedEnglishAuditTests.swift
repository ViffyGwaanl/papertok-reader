    ...
    func auditedUIFilesAvoidBareEnglish() throws {
        let violations = try scan(
            files: [
                ...
                "Packages/PTFeatures/Sources/PTFeatures/Settings/AITitleGenerationSettingsView.swift",
                "Packages/PTFeatures/Sources/PTFeatures/Settings/NarrateTranslateSettingsView.swift",
                "Packages/PTFeatures/Sources/PTFeatures/Settings/UsageDashboardView.swift",
