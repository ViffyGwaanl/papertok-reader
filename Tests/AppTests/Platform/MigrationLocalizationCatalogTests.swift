...
struct MigrationLocalizationCatalogTests {
    ...
    func catalogContainsCriticalKeys() throws {
        ...
        let requiredKeys: Set<String> = [
            ...
            "chat.provider.thinking.budget_tokens.title",
            "chat.provider.thinking.budget_tokens.hint",
            "chat.provider.capability.tools",
            "chat.provider.capability.vision",
            "chat.provider.capability.thinking",
            "chat.provider.capability.image_generation",
            "chat.provider.chip.tooltip",
            "chat.provider.chip.configure_action",
            ...
            "reader.annotation.edit.sheet.title",
            "reader.annotation.edit.change_kind",
            "reader.annotation.edit.change_color",
            "reader.annotation.edit.delete_confirm.title",
            "reader.annotation.edit.delete_confirm.message",
            "reader.annotation.edit.copy_text",
            "reader.annotation.edit.share",
            "reader.ai.scope.selection.disabled",
            ...
            "reader.translation.fulltext.retry_failed",
            ...
            "reader.toc.search.placeholder",
            "reader.toc.search.no_matches",
            "reader.footnote.close",
            "reader.footnote.title",
            "reader.toolbar.bookmark.add",
            "reader.toolbar.bookmark.remove",
            "reader.keyboard.shortcut.page_turn",
            ...
            "tab.memory",
            "settings.mcp.section_title",
            "settings.mcp.add_button",
            "settings.mcp.empty.title",
            "settings.mcp.empty.body",
            "settings.mcp.detail.title_new",
            "settings.mcp.detail.title_edit",
            "settings.mcp.general.section",
            "settings.mcp.general.name",
            "settings.mcp.general.name.placeholder",
            "settings.mcp.general.transport",
            "settings.mcp.general.enabled",
            "settings.mcp.transport.stdio",
            "settings.mcp.transport.http_sse",
            "settings.mcp.connection.section",
            "settings.mcp.connection.command",
            "settings.mcp.connection.arguments",
            "settings.mcp.connection.environment",
            "settings.mcp.connection.env.add",
            "settings.mcp.connection.env.key",
            "settings.mcp.connection.env.value",
            "settings.mcp.connection.url",
            "settings.mcp.connection.url.invalid",
            "settings.mcp.auth.section",
            "settings.mcp.auth.api_key",
            "settings.mcp.auth.api_key.placeholder",
            "settings.mcp.auth.custom_headers",
            "settings.mcp.auth.headers.add",
            "settings.mcp.tools.section",
            "settings.mcp.tools.connect_button",
            "settings.mcp.tools.connecting",
            "settings.mcp.tools.disconnected",
            "settings.mcp.tools.connected_format",
            "settings.mcp.tools.not_connected",
            "settings.mcp.tools.test_run",
            "settings.mcp.tools.run_sheet.title_format",
            "settings.mcp.tools.run_sheet.arguments",
            "settings.mcp.tools.run_sheet.run_button",
            "settings.mcp.tools.run_sheet.result",
            "settings.mcp.tools.run_sheet.invalid_json",
            "settings.mcp.diagnostics.section",
            "settings.mcp.diagnostics.last_attempt",
            "settings.mcp.diagnostics.never",
            "settings.mcp.diagnostics.last_error",
            "settings.mcp.delete.confirm.title",
            "settings.mcp.delete.confirm.message",
            "settings.mcp.save_button",
            "settings.mcp.validation.name_required",
            "settings.mcp.validation.url_required",
            "settings.mcp.validation.command_required",
        ]
    ...
    func auditedFilesHaveCatalogCoverage() throws {
        ...
        let keys = try extractedLocalizationKeys(
            from: [
                ...
                // ProviderPickerSheet.swift retired in W5.3.
                ...
                "Packages/PTFeatures/Sources/PTFeatures/Reader/ThemeSwatchPicker.swift",
                ...
                "Packages/PTFeatures/Sources/PTFeatures/Settings/MCPServerListView.swift",
                "Packages/PTFeatures/Sources/PTFeatures/Settings/MCPServerDetailView.swift",
                "Packages/PTFeatures/Sources/PTFeatures/Settings/MCPServerDetailViewModel.swift",
                "Packages/PTFeatures/Sources/PTFeatures/Settings/MCPToolRunSheet.swift",
