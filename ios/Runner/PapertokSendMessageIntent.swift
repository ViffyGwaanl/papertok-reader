...
struct PapertokSendMessageIntent: AppIntent {
  ...
  func perform() async throws -> some IntentResult & ReturnsValue<String> {
    ...
    // Keep one concrete PerformResult type to satisfy Swift's opaque return type rules,
    // but preserve product semantics: when showDialog is off, do not provide a dialog.
