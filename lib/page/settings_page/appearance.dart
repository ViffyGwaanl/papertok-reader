...
import 'package:papertok_reader/widgets/settings/simple_dialog.dart';
import 'package:papertok_reader/widgets/settings/theme_mode.dart';
        ...
        SettingsSection(
          ...
          tiles: [
            SettingsTile.navigation(
              ...
              description:
                  Text(L10n.of(context).settingsHomeNavigationSubtitle),
