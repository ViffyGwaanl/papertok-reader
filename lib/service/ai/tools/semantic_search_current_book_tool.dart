...
final AiToolDefinition
semanticSearchCurrentBookToolDefinition = AiToolDefinition(
  id: 'semantic_search_current_book',
  displayNameBuilder: (_) => 'Semantic search (current book)',
  descriptionBuilder: (_) =>
      'Semantic vector search within the currently opened book. Requires a local index (build from Reading → Settings → Other).',
